...
class Notes(Resource):
    ...
    def post(self):
        ...
        parser.add_argument('notefolder_id', type=int, required=True,
                            help='notefolder_id cannot be blank!')
        parser.add_argument('entry_id', type=str, required=True,
    ...
    def put(self):
        ...
        parser.add_argument('notefolder_id_dst', type=int,
